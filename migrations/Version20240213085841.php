 ...
 */
final class Version20240213085841 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE forecast (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, celsius INT NOT NULL, location_id INT NOT NULL, INDEX IDX_2A9C784464D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
